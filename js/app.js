...
const basketModal = document.querySelector(".basket-screen")
...
function clearBasket(){
  ...
  showBasketProducts()
  basketBtnCount.classList.add("hidden")
  localStorage.clear()
}
...
basketBtn.addEventListener("click" , showBasketModal)
closeBasketBtn.addEventListener("click" , hideBasketModal)
